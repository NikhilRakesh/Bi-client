  ...
  return (
    <div>
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg bg-gradient-to-r from-indigo-50 to-sky-50">
        ...
        <p className="text-gray-700 mb-4">
          This Merchant Policy describes Our policies and procedures on the
        ...
        <p className="text-gray-700 mb-4">
          ...
          accordance with this Merchant Policy. This Privacy Policy has been created
        ...
        <p className="text-gray-700 mb-4">
          We may update this Merchant Privacy Policy from time to time. Any changes will be posted here and you will be notified via email.
        </p>
